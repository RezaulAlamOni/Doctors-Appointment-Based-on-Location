...
<div id="main-wrapper">
    ...
    <div class="page-container"><script>
        ...
        <form action="http://pepdev.com/theme-preview/klinikal/admin/index.php?route=themeoption/department/action" method="post" enctype="multipart/form-data" siq_id="autopick_4656">
