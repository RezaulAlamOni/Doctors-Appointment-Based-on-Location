...
<div class="page-hdr">
	<div class="row">
		<div class="col-4 page-name">
			<h1><i class="fa fa-black-tie"></i>Users</h1>
		</div>
        <div class="page-name col-3 text-right">
            <h1 id="time">Time</h1>
        </div>
		<div class="col-5 page-menu">
			<a id="cancel" href="index.php?route=subscriber" data-toggle="tooltip" data-placement="left" title="Reload"><i class="fa fa-refresh"></i></a>
			<a href="index.php?route=subscriber/add" data-toggle="tooltip" data-placement="left" title="Add Subscriber"><i class="fa fa-plus"></i></a>
		</div>
	</div>
</div>
<div class="content">
		...
		<table id="subscriber-table" class="table table-bordered table-striped datatable-table">
			...
			<tbody>
					...
					<td class="table-action">
						<a href="index.php?route=subscriber/edit&id=29" class="btn btn-outline btn-info btn-outline-1x btn-circle" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
