<head>
    ...
    <title>Klinikal Health care- My Invoices</title>
...
<div class="color scroll-to-fixed-fixed" style="z-index: 1000; position: fixed; top: 200px; margin-left: 0px; width: 449px; left: 0px;">
...
</div><div style="display: block; width: 449px; height: 0px; float: none;"></div>
<!-- Header Start -->
<header id="header">
        ...
        <div class="layer-stretch hdr-top">
            <div class="hdr-top-block hidden-xs">
                <div id="hdr-social">
                    <ul class="social-list social-list-sm">
                        ...
                        <li><a href="https://www.facebook.com/pepdevofficial" target="_blank" id="hdr-facebook" tabindex="0"><i class="fa fa-facebook"></i></a><span class="mdl-tooltip mdl-tooltip--bottom" for="hdr-facebook" data-upgraded=",MaterialTooltip">Facebook</span></li>
                        <li><a href="https://twitter.com/pepdevofficial" target="_blank" id="hdr-twitter" tabindex="0"><i class="fa fa-twitter"></i></a><span class="mdl-tooltip mdl-tooltip--bottom" for="hdr-twitter" data-upgraded=",MaterialTooltip">Twitter</span></li>
                        <li><a href="https://plus.google.com/110823961031348424693" target="_blank" id="hdr-google" tabindex="0"><i class="fa fa-google"></i></a><span class="mdl-tooltip mdl-tooltip--bottom" for="hdr-google" data-upgraded=",MaterialTooltip">Google</span></li>
                        <li><a href="https://www.instagram.com/pepdevofficial/" target="_blank" id="hdr-instagram" tabindex="0"><i class="fa fa-instagram"></i></a><span class="mdl-tooltip mdl-tooltip--bottom" for="hdr-instagram" data-upgraded=",MaterialTooltip">Instagram</span></li>
                        <li><a href="https://www.youtube.com/channel/UCRuPHwjNznZilEvlGIr1Y1Q" target="_blank" id="hdr-youtube" tabindex="0"><i class="fa fa-youtube"></i></a><span class="mdl-tooltip mdl-tooltip--bottom" for="hdr-youtube" data-upgraded=",MaterialTooltip">Youtube</span></li>
                        <li><a href="https://www.linkedin.com/" target="_blank" id="hdr-linkedin" tabindex="0"><i class="fa fa-linkedin"></i></a><span class="mdl-tooltip mdl-tooltip--bottom" for="hdr-linkedin" data-upgraded=",MaterialTooltip">Linkedin</span></li>
                        <li><a href="https://www.flickr.com/" target="_blank" id="hdr-flickr" tabindex="0"><i class="fa fa-flickr"></i></a><span class="mdl-tooltip mdl-tooltip--bottom" for="hdr-flickr" data-upgraded=",MaterialTooltip" style="left: 809.453px; margin-left: -23.5px; top: 43px;">Flickr</span></li>
                        <li><a href="https://www.rss.com/" target="_blank" id="hdr-rss" tabindex="0"><i class="fa fa-rss"></i></a><span class="mdl-tooltip mdl-tooltip--bottom" for="hdr-rss" data-upgraded=",MaterialTooltip" style="left: 837.109px; margin-left: -17.5px; top: 43px;">Rss</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="hdr-top-block">
                <div class="theme-dropdown">
                    <a id="profile-menu" class="mdl-button mdl-js-button mdl-js-ripple-effect font-13" data-upgraded=",MaterialButton,MaterialRipple">
                        <i class="fa fa-user-o color-black"></i> oni asdfasd                        <span class="mdl-button__ripple-container"><span class="mdl-ripple is-animating" style="width: 211.54px; height: 211.54px; transform: translate(-50%, -50%) translate(71px, 18px);"></span></span></a>
                    <div class="mdl-menu__container is-upgraded" style="right: 0px; top: 36px; width: 165.656px; height: 304px;"><div class="mdl-menu__outline mdl-menu--bottom-right" style="width: 165.656px; height: 304px;"></div><ul id="hdr-user-menu-dd" class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-js-ripple-effect--ignore-events" for="profile-menu" data-upgraded=",MaterialMenu,MaterialRipple" style="clip: rect(0px, 165.656px, 0px, 165.656px);">
                            <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple" style="">
                                <a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/appointment"><i class="fa fa-plus-square-o"></i>My Appointments</a>
                                <span class="mdl-menu__item-ripple-container"><span class="mdl-ripple"></span></span></li>
                            <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple" style="">
                                <a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/invoices"><i class="fa fa-envelope-o"></i>My Invoices</a>
                                <span class="mdl-menu__item-ripple-container"><span class="mdl-ripple"></span></span></li>
                            <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple" style="">
                                <a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/request"><i class="fa fa-envelope-o"></i>My Requests</a>
                                <span class="mdl-menu__item-ripple-container"><span class="mdl-ripple"></span></span></li>
                            <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple" style="">
                                <a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/profile"><i class="fa fa-address-card-o"></i>My Profile</a>
                                <span class="mdl-menu__item-ripple-container"><span class="mdl-ripple"></span></span></li>
                            <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple" style="">
                                <a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/profile/edit"><i class="fa fa-key"></i>Change Password</a>
                                <span class="mdl-menu__item-ripple-container"><span class="mdl-ripple"></span></span></li>
                            <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple" style="">
                                <a href="http://pepdev.com/theme-preview/klinikal/index.php?route=logout"><i class="fa fa-sign-out"></i>Logout</a>
                                <span class="mdl-menu__item-ripple-container"><span class="mdl-ripple"></span></span></li>
                        </ul></div>
                </div>
            </div>
    ...
    <div id="hdr-wrapper" style="z-index: 1000;">
            ...
            <div class="tbl">
                <div class="tbl-row">
                    ...
                    <div class="tbl-cell hdr-menu">
                        <ul class="menu">
                            <li>
                                <a id="menu-home" class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">
                                    Home <i class="fa fa-chevron-down"></i>
                                    <span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></a>
                                <div class="mdl-menu__container is-upgraded"><div class="mdl-menu__outline mdl-menu--bottom-right"></div><ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-js-ripple-effect--ignore-events" for="menu-home" data-upgraded=",MaterialMenu,MaterialRipple">
                            ...
                            <li>
                                <a id="menu-pages" class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">
                                    Pages <i class="fa fa-chevron-down"></i>
                                    <span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></a>
                                <div class="mdl-menu__container is-upgraded"><div class="mdl-menu__outline mdl-menu--bottom-right"></div><ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-js-ripple-effect--ignore-events" for="menu-pages" data-upgraded=",MaterialMenu,MaterialRipple">
                                        <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple">
                            ...
                            <li>
                                <a id="menu-service" class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">
                                    Service <i class="fa fa-chevron-down"></i>
                                    <span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></a>
                                <div class="mdl-menu__container is-upgraded"><div class="mdl-menu__outline mdl-menu--bottom-right"></div><ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-js-ripple-effect--ignore-events" for="menu-service" data-upgraded=",MaterialMenu,MaterialRipple">
                                        <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple">
                            ...
                            <li>
                                <a id="menu-doctor" class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">Doctors <i class="fa fa-chevron-down"></i><span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></a>
                                <div class="mdl-menu__container is-upgraded"><div class="mdl-menu__outline mdl-menu--bottom-right"></div><ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-js-ripple-effect--ignore-events" for="menu-doctor" data-upgraded=",MaterialMenu,MaterialRipple">
                                        <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple">
                            ...
                            <li>
                                <a id="menu-blog" class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">
                                    Blogs <i class="fa fa-chevron-down"></i>
                                    <span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></a>
                                <div class="mdl-menu__container is-upgraded"><div class="mdl-menu__outline mdl-menu--bottom-right"></div><ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-js-ripple-effect--ignore-events" for="menu-blog" data-upgraded=",MaterialMenu,MaterialRipple">
                                        <li class="mdl-menu__item mdl-js-ripple-effect" tabindex="-1" data-upgraded=",MaterialRipple">
                            ...
                            <li>
                                <a href="http://pepdev.com/theme-preview/klinikal/index.php?route=shortcodes" id="menu-shortcodes" class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">Shortcodes<span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></a>
                            </li>
                            <li>
                                <a href="http://pepdev.com/theme-preview/klinikal/admin/" id="menu-admin" class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">Admin Panel<span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></a>
                            </li>
...
<div id="tt" class="animated-wrapper" style="opacity: 0;">
    <div class="layer-stretch">
        <div class="layer-wrapper">
            ...
            <div class="layer-container">
                <div class="tt-block animated animated-up">
                    ...
                    <p>
                        <button class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">Make An Appointment<span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></button>
                    </p>
                </div>
                <div class="tt-block animated animated-up">
...
<div id="emergency">
    <div class="layer-stretch">
        <div class="layer-wrapper animated-wrapper" style="opacity: 0;">
            <div class="layer-ttl">
...
<div id="appointment-button">
    <button id="appointment-now" class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored mdl-button--raised animated slideInUp" data-upgraded=",MaterialButton,MaterialRipple" tabindex="0"><i class="fa fa-plus"></i><span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></button>
    <div class="mdl-tooltip mdl-tooltip--top" data-mdl-for="appointment-now" data-upgraded=",MaterialTooltip">Make An Appointment</div>
                ...
                <div class="footer-container footer-b">
                    <div class="tbl">
                        <div class="tbl-row">
                            ...
                            <ul class="tbl-cell">
                                <li><a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/appointment">My Appointments</a></li>
                                <li><a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/invoices">My Invoices</a></li>
                                <li><a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/request">My Requests</a></li>
                                <li><a href="http://pepdev.com/theme-preview/klinikal/index.php?route=user/profile">My Profile</a></li>
                                <li><a href="http://pepdev.com/theme-preview/klinikal/index.php?route=logout">Logout</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="footer-subscribe">
                        <form action="http://pepdev.com/theme-preview/klinikal/index.php?route=subscribe" method="post">
                            ...
                            <div class="footer-subscribe-button">
                                <button type="submit" id="subscribe-submit" name="subscribe" class="mdl-button mdl-js-button mdl-js-ripple-effect button button-primary" data-upgraded=",MaterialButton,MaterialRipple">Submit<span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></button>
                            </div>
                        </form>
                    </div>
                    <div class="social-list social-list-colored footer-social">
                        <li>
                            <a href="https://www.facebook.com/pepdevofficial" target="_blank" id="footer-facebook" class="fa fa-facebook" tabindex="0"></a>
                            <span class="mdl-tooltip mdl-tooltip--top" for="footer-facebook" data-upgraded=",MaterialTooltip">Facebook</span>
                        </li>
                        <li>
                            <a href="https://twitter.com/pepdevofficial" target="_blank" id="footer-twitter" class="fa fa-twitter" tabindex="0"></a>
                            <span class="mdl-tooltip mdl-tooltip--top" for="footer-twitter" data-upgraded=",MaterialTooltip">Twitter</span>
                        </li>
                        <li>
                            <a href="https://plus.google.com/110823961031348424693" target="_blank" id="footer-google" class="fa fa-google" tabindex="0"></a>
                            <span class="mdl-tooltip mdl-tooltip--top" for="footer-google" data-upgraded=",MaterialTooltip">Google</span>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/pepdevofficial/" target="_blank" id="footer-instagram" class="fa fa-instagram" tabindex="0"></a>
                            <span class="mdl-tooltip mdl-tooltip--top" for="footer-instagram" data-upgraded=",MaterialTooltip">Instagram</span>
                        </li>
                        <li>
                            <a href="https://www.youtube.com/channel/UCRuPHwjNznZilEvlGIr1Y1Q" target="_blank" id="footer-youtube" class="fa fa-youtube" tabindex="0"></a>
                            <span class="mdl-tooltip mdl-tooltip--top" for="footer-youtube" data-upgraded=",MaterialTooltip">Youtube</span>
                        </li>
                        <li>
                            <a href="https://www.linkedin.com/" target="_blank" id="footer-linkedin" class="fa fa-linkedin" tabindex="0"></a>
                            <span class="mdl-tooltip mdl-tooltip--top" for="footer-linkedin" data-upgraded=",MaterialTooltip">Linkedin</span>
                        </li>
                        <li>
                            <a href="https://www.flickr.com/" target="_blank" id="footer-flickr" class="fa fa-flickr" tabindex="0"></a>
                            <span class="mdl-tooltip mdl-tooltip--top" for="footer-flickr" data-upgraded=",MaterialTooltip">Flickr</span>
                        </li>
                        <li>
                            <a href="https://www.rss.com/" target="_blank" id="footer-rss" class="fa fa-rss" tabindex="0"></a>
                            <span class="mdl-tooltip mdl-tooltip--top" for="footer-rss" data-upgraded=",MaterialTooltip">Rss</span>
                        </li>
                    </div>
                </div>
            </div>
...
<script src="public/js/custom.js"></script><ul id="ui-id-1" tabindex="0" class="ui-menu ui-widget ui-widget-content ui-autocomplete ui-front" style="display: none;"></ul><div role="status" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div>
<script>$('#menu-invoices').addClass('active');</script>	<!-- Custom Css -->
<style></style>
