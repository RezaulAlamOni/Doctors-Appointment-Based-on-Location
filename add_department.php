<html lang="en"><head>
    ...
    <link rel="stylesheet" href="https://css.zohostatic.com/salesiq/Sep_21_2018_4_https/styles/floatbutton.css"><script src="https://js.zohostatic.com/salesiq/Sep_21_2018_4_https/js/floatbutton.js"></script></head>
<body>
<!-- Media Modal -->
...
<div id="main-wrapper">
    ...
    <div class="page-container"><script>
        ...
        <form action="http://pepdev.com/theme-preview/klinikal/admin/index.php?route=themeoption/department/action" method="post" enctype="multipart/form-data" siq_id="autopick_7595">
                ...
                <div class="content-block">
                    ...
                    <div class="content-block-main">
                        ...
                        <div class="content-input">
                            ...
                            <input type="text" class="input-text" value="" name="icon" placeholder="Enter Icon Name (Ex. - user)" required="">
